...
const sections = [
  {
    title: '運営者情報',
    body: [
      '当サイト「ママさんマネー部」（https://mamasanmoney-bu.com）は、ママさんマネー部 編集部が運営しています。'
    ]
  },
  {
    title: '取得する個人情報',
    body: [
      ...
      'お問い合わせはメール（contact@example.com など）にて受け付けており、ご連絡いただいた際に記載された氏名・メールアドレス・本文を、内容確認と返答のために利用します。',
  ...
  },
  {
    title: 'お問い合わせ先',
    body: [
      '本ポリシーに関するお問い合わせは、サイト内の「お問い合わせ」ページに記載のメールアドレスまでお願いいたします。'
    ]
  }
]
