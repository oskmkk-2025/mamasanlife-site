...
const timeline = [
  ...
  },
  {
    year: '暮らしの再設計',
    title: 'ライフスタイルの転換',
    body: '健康志向が高まり、運動・禁煙・禁酒に挑戦。必要な保険を残しつつ多くを解約し、暮らしと資産のバランスを取り直しました。'
  },
  {
    year: '2025.11',
    title: 'Mamasan Life へ',
    body: 'ブランド名を「Mamasan Life」に刷新。週4日の事務パートと家庭を両立しながら、準富裕層を目指した蓄財を継続しています。'
  },
  {
    year: '現在',
    title: '事務スキルを再武装',
    body: 'パート契約を満了し、現在は半年間の職業訓練校（Webクリエイト科）で学び直し中。デザインやコーディングを磨き、在宅ワークとブログ運営の両立を目指しています。'
  }
]
