...
export const metadata = {
  title: '運営者情報・プロフィール',
  description: 'FP2級・簿記2級を持つ2児の母「ひーちママ」のプロフィール。家計管理・固定費削減の実体験に加え、ポッドキャスト配信やAIでのゲームづくりにも挑戦しています。',
...
const timeline = [
  ...
  },
  {
    year: '2026.前半',
    title: '学び直しのその後',
    body: '職業訓練校（Webマーケティング＋Webデザイン）を修了。就職活動の末に事務職で復職しましたが、初めての業界に馴染めず1ヶ月で退職しました。うまくいかなかったことも、そのまま記事にしています。'
  },
  {
    year: '2026.7',
    title: 'ポッドキャストを開始',
    body: '毎週金曜の朝7時に「ママさんライフラジオ」を配信スタート。電気代やスマホ代、給湯器の交換まで、記事に書いた実額を今度は「声」でお話ししています。'
  },
  {
    year: '2026',
    title: 'AIと、つくる側へ',
    body: 'プログラミングは未経験のまま、AIと一緒にスマホゲームを2本公開。ブログ自体もWordPressをやめてAIで作り直し、サーバー代は0円になりました。'
  },
  {
    year: '現在',
    title: '在宅ワークの土台づくり',
    body: '無理に中途半端な就職を急がず、健康を最優先に。低山歩きで体を整えながら、生成AIを学んで在宅で働くための基盤をつくっています。'
  }
]
...
const values = [
  {
    ...
    body: [
      ...
      '40代で職業訓練校に通ってWebデザインとマーケティングを学びました。いまは生成AIを使って、ブログの作り替えやゲームづくりに挑戦中です。'
    ]
  },
  {
    title: '大切にしていること',
  ...
  },
  {
    ...
    body: [
      ...
      'Webデザインや生成AIの知識を在宅ワークに活かしつつ、暮らし・教育・働き方・旅行のノウハウを記事や音声にして、読者同士の「気づき」が広がる場をつくること。'
    ]
  }
]
...
export default function AboutPage() {
  return (
    <main className="container-responsive py-12 max-w-4xl space-y-10">
          ...
          <div className="w-full space-y-4 text-center md:flex-1 md:text-left">
            ...
            <div className="rounded-2xl border border-[var(--c-accent-light)] bg-white/80 px-5 py-4 text-left text-gray-700 shadow-sm">
              <p className="text-lg leading-8">
                ...
                40代で職業訓練校に通ってWebデザインとWebマーケティングを学び、いまは生成AIを相棒に、ブログだけでなくポッドキャストやゲームづくりにも手を広げています。
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-semibold text-emphasis">いま発信していること</h2>
        <ul className="list-disc pl-6 space-y-2 text-gray-700 leading-7">
          <li>
            <strong>ブログ</strong>：家計・子育て・暮らし・働き方の体験談。かかった金額はできるだけ実額で書いています。
          </li>
          <li>
            <strong><a href="/podcast" className="underline underline-offset-2 text-[var(--c-emphasis)] hover:text-[var(--c-primary)]">ポッドキャスト「ママさんライフラジオ」</a></strong>：毎週金曜の朝7時に更新。家事をしながら聴けるよう、1本10分ほどにしています。
          </li>
          <li>
            <strong><a href="/games" className="underline underline-offset-2 text-[var(--c-emphasis)] hover:text-[var(--c-primary)]">ゲームひろば</a></strong>：AIと一緒に作った、無料・インストール不要の親子向けゲーム。
          </li>
        </ul>
      </section>
